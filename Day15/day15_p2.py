...
if __name__ == '__main__':
    ...
    oxygen_location, _ = droid.find_oxygen_system()
    minutes_until_full = droid.minutes_to_fill_with_oxygen(oxygen_location)
    print(f'It will take {minutes_until_full} minutes for the oxygen to fill the area.')
